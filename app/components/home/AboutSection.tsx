...
import LogotypeCard from "../style/LogotypeCard";

const AboutSection = () => {
  const navigator = useRouter();
  return (
    <section className="md:px-40 px-5 py-8.5 flex flex-col md:flex-row md:gap-52 gap-5 md:mt-[5.5%] z-40">
      <LogotypeCard />
      <div className="flex-1 flex flex-col items-center">
        <h4 className="font-normal text-neutral-500">
          ...
          taxonômicas e ecológicas sobre espécies, com base nos dados da API do <i>Global
          Biodiversity Information Facility <a href="https://www.gbif.org" about="_blank">(GBIF)</a></i>. A plataforma foi
